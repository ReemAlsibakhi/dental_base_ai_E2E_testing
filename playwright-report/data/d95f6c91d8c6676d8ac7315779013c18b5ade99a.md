...
- Name: insurance-billing/finance.spec.ts >> Finance >> TC-F-IB2-09 add provider from Quick Add list
- Location: tests/insurance-billing/finance.spec.ts:44:7
...
Call log:
  - waiting for locator('h3').filter({ hasText: 'Finance' }).locator('..').locator('..').getByRole('button', { name: 'Edit' }).first()
    - waiting for "https://dentalbase-dev-v2.vercel.app/login" navigation to finish...
    - navigated to "https://dentalbase-dev-v2.vercel.app/login"
