"""
tests/practice_profile/test_practice_address.py
...
def test_street_empty_shows_required(practice_profile_form_open):
...
@pytest.mark.negative
def test_street_whitespace_shows_required(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.street_input, "   ")
    expect(practice_profile_form_open.street_error).to_contain_text("required")
...
def test_street_xss_rejected(practice_profile_form_open):
...
def test_street_min_5_chars_accepted(practice_profile_form_open):
...
@pytest.mark.boundary
def test_street_4_chars_triggers_error(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.street_input, STREET_MIN_INVALID)
    expect(practice_profile_form_open.street_error).to_be_visible()


@pytest.mark.boundary
def test_street_max_200_chars_accepted(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.street_input, STREET_MAX_VALID)
    expect(practice_profile_form_open.street_error).to_be_hidden()


@pytest.mark.boundary
def test_street_201_chars_blocked(practice_profile_form_open):
...
@pytest.mark.negative
def test_city_empty_shows_required(practice_profile_form_open):
...
@pytest.mark.negative
def test_city_whitespace_shows_required(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.city_input, "   ")
    expect(practice_profile_form_open.city_error).to_contain_text("required")
...
@pytest.mark.negative
@pytest.mark.security
def test_city_xss_rejected(practice_profile_form_open):
...
@pytest.mark.boundary
def test_city_min_2_chars_accepted(practice_profile_form_open):
...
@pytest.mark.boundary
def test_city_1_char_triggers_error(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.city_input, CITY_MIN_INVALID)
    expect(practice_profile_form_open.city_error).to_be_visible()


@pytest.mark.boundary
def test_city_max_100_chars_accepted(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.city_input, CITY_MAX_VALID)
    expect(practice_profile_form_open.city_error).to_be_hidden()


@pytest.mark.boundary
def test_city_101_chars_blocked(practice_profile_form_open):
...
@pytest.mark.negative
def test_zip_empty_shows_required(practice_profile_form_open):
...
@pytest.mark.negative
def test_zip_letters_rejected(practice_profile_form_open):
...
@pytest.mark.boundary
def test_zip_5_digits_accepted(practice_profile_form_open):
...
@pytest.mark.boundary
def test_zip_4_digits_triggers_error(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.zip_input, ZIP_INVALID_4)
    expect(practice_profile_form_open.zip_error).to_be_visible()


@pytest.mark.boundary
def test_zip_plus4_format_accepted(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.zip_input, ZIP_VALID_PLUS4)
    expect(practice_profile_form_open.zip_error).to_be_hidden()


@pytest.mark.boundary
def test_zip_plus4_incomplete_rejected(practice_profile_form_open):
    _fill(practice_profile_form_open, practice_profile_form_open.zip_input, ZIP_INVALID_PLUS4)
    expect(practice_profile_form_open.zip_error).to_be_visible()


# ===========================================================================
# State + Timezone (PP·R10/R12)
# ===========================================================================

@pytest.mark.negative
def test_state_has_default_value(practice_profile_form_open):
    practice_profile_form_open.state_select.scroll_into_view_if_needed()
    assert practice_profile_form_open.state_select.input_value() != ""


@pytest.mark.negative
def test_timezone_has_default_value(practice_profile_form_open):
    practice_profile_form_open.timezone_select.scroll_into_view_if_needed()
    assert practice_profile_form_open.timezone_select.input_value() != ""
